...
export type BlockResolvers<ContextType = MyContext, ParentType extends ResolversParentTypes['Block'] = ResolversParentTypes['Block']> = ResolversObject<{
  block_index?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
...
export type QueryResolvers<ContextType = MyContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  getBlock?: Resolver<ResolversTypes['Block'], ParentType, ContextType, Partial<QueryGetBlockArgs>>;
  getBlocks?: Resolver<Array<ResolversTypes['Block']>, ParentType, ContextType, RequireFields<QueryGetBlocksArgs, 'dt'>>;
}>;
